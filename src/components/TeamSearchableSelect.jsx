...
const TeamSearchableSelect = React.memo(({ teams, selectedTeam, onSelectTeam }) => {
  ...
  const filteredTeams = teams.filter((team) => team.toLowerCase().includes(searchTerm.toLowerCase()));
