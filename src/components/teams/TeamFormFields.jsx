  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="block text-xs font-semibold text-slate-600 mb-1.5">CategorÃ­a</label>
          <select
        ...
        <div>
          <label className="block text-xs font-semibold text-slate-600 mb-1.5">GÃ©nero</label>
          <select
            value={form.genero}
      ...
      {esSenior && (
        <div>
          <label className="block text-xs font-semibold text-slate-600 mb-1.5">
            DivisiÃ³n <span className="text-slate-400 font-normal">(opcional)</span>
          </label>
          <input
            type="text"
            value={form.division || ''}
            onChange={(e) => setForm((f) => ({ ...f, division: e.target.value }))}
            placeholder="Nacional, Sub22, AutonÃ³mica..."
      ...
      {!esSenior && (
        <div>
          <label className="block text-xs font-semibold text-slate-600 mb-1.5">AÃ±o</label>
