...
export function BracketProvider({ initialShareCode, initialTeamId, onShareCodeConsumed, shareUrlBase, children }) {
  ...
  const value = {
    ...
    manualTeamCount: creation.manualTeamCount,
    setManualTeamCount: creation.setManualTeamCount,
    manualFormat: creation.manualFormat,
    setManualFormat: creation.setManualFormat,
    // Editor
    zoom: editor.zoom,
    ...
    handleEditTeamName: editor.handleEditTeamName,
    handleEditMatchSettings: editor.handleEditMatchSettings,
