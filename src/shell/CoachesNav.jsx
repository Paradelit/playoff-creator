...
function CreateSheet({ onClose }) {
  ...
  function handleTrainingAction() {
    ...
    if (teams.length === 1) {
      handleNewTrainingForTeam(teams[0]);
      return;
    }
  ...
  return (
    <>
      ...
      {/* Sheet */}
      <div
        className="fixed bottom-0 left-0 right-0 z-[160] bg-white rounded-t-3xl shadow-2xl animate-in slide-in-from-bottom duration-250 max-h-[85vh] overflow-y-auto"
